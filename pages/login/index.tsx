...
export default function Login() {
    ...
    return (
        <div className='flex justify-center items-center from-blue-300 bg-gradient-to-r to-blue-400  h-[100vh] px-[70vh]'>
            <Head>
                <title>Login</title>
            </Head>
            <div className='bg-white shadow-lg rounded-lg p-5 w-full h-auto flex justify-center flex-col gap-4 items-center'>
                <h5 className='text-xl font-bold'>Admin Warung Alvine</h5>
